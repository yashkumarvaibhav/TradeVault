...
describe("environment contract", () => {
  ...
  it("validates configured URLs and paired PostHog settings", () => {
    ...
    expect(() => readServerEnvironment({ NEXT_PUBLIC_POSTHOG_KEY: "ph_test" })).toThrow("NEXT_PUBLIC_POSTHOG_HOST");
    ...
    })).toMatchObject({ databaseUrl: "postgresql://localhost/tradevault", posthogKey: "ph_test" });
  });
