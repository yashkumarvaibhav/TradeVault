...
export const trades = pgTable("trades", {
  ...
  mfePrice: numeric("mfe_price", { precision: 20, scale: 6 }),
  maePrice: numeric("mae_price", { precision: 20, scale: 6 }),
  mfeAmount: numeric("mfe_amount", { precision: 20, scale: 6 }),
  maeAmount: numeric("mae_amount", { precision: 20, scale: 6 }),
  mfeR: numeric("mfe_r", { precision: 16, scale: 6 }),
  maeR: numeric("mae_r", { precision: 16, scale: 6 }),
  capturedMovePct: numeric("captured_move_pct", { precision: 16, scale: 6 }),
  ...
  check("trades_mfe_amount_nonnegative_check", sql`${table.mfeAmount} is null or ${table.mfeAmount} >= 0`),
  check("trades_mae_amount_nonnegative_check", sql`${table.maeAmount} is null or ${table.maeAmount} >= 0`),
  check("trades_mfe_r_nonnegative_check", sql`${table.mfeR} is null or ${table.mfeR} >= 0`),
  check("trades_mae_r_nonnegative_check", sql`${table.maeR} is null or ${table.maeR} >= 0`),
